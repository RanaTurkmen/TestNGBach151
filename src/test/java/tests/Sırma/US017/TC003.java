...
public class TC003 extends ExtentReport{
    ...
    public void test01() {
        ...
        extentTest.info("Satın alınacak ürün sepete eklendiği doğrulandı");
        ...
        page.bilingDetails.sendKeys(faker.address().streetAddress(),Keys.TAB,
                                               faker.address().city(),Keys.TAB,
                                               faker.address().city(),Keys.TAB,"New york");
        ReusableMethods.bekle(1);
        ...
        page.zipKod.sendKeys("1001?",Keys.TAB,
                                         "212937076k",Keys.TAB,Keys.TAB,Keys.TAB,
                                         "Ürünleri hediye paketi yaparsanız memnun olurum",Keys.TAB);
                                          ReusableMethods.bekle(1);
        ...
        extentTest.info("Posta kodunun noktalama içermemesi gerektiği doğrulandı");
        ...
        extentTest.info("Telefon numarasının harf içermemesi gerektiği doğrulandı");
