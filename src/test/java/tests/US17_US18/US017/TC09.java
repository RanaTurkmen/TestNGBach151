...
public class TC09 extends ExtentReport {
    ...
    public void test01() {
        ...
        page.bilingDetails.sendKeys(Keys.CONTROL,"A",Keys.CONTROL,faker.address().streetAddress(),Keys.TAB, Keys.TAB,
                Keys.CONTROL,"A",Keys.CONTROL,"3400000006556655555555555",Keys.TAB,
        ...
        //Sayfanın üstünde "Billing Postcode/ZIP is a required field." mesajı çıktığını doğrula
        Assert.assertTrue(page.hata1.getText().contains("Billing Postcode/ZIP is a required field."));
        extentTest.fail("Sayfanın üstünde Billing Postcode/ZIP is a required field. mesajı çıktığı doğrulanamadı");
