...
public class TC002 extends ExtentReport {
    ...
    public void test01() {
        ...
        extentTest.pass("Seçilen ürünlerin Sepet ikonu altında View cart yazısı çıktığını doğrulandı");
       ...
       ReusableMethods.bekle(5);
        ...
        extentTest.pass("Zoronlu doldurulması gereken ve doldurulmayan alanların hata mesajları doğrulandı");
