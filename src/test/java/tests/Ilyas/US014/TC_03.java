...
public class TC_03 {
    ...
    public void test01() {
        ...
        page.productTitle.sendKeys("Süt",Keys.TAB,Keys.TAB,Keys.TAB,Keys.TAB,"Laktozsuz Süt",
        Keys.TAB,Keys.TAB,"Kaliteli Laktozsuz Süt");
        ReusableMethods.scroll(page.draft);
